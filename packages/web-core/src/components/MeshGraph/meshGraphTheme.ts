...
export function getMeshGraphTheme(theme: Theme): MeshGraphTheme {
    if (theme === 'light') {
        return {
            ...
            dialogOverlayClass: 'fixed inset-0 z-[1200] flex items-stretch justify-center bg-[rgba(15,23,42,0.82)] p-0 md:items-center md:p-4',
    ...
    return {
        ...
        dialogOverlayClass: 'fixed inset-0 z-[1200] flex items-stretch justify-center bg-[#030617]/[0.92] p-0 md:items-center md:p-4',
