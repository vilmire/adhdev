...
export function getMeshGraphTheme(theme: Theme): MeshGraphTheme {
    if (theme === 'light') {
        return {
            ...
            dialogOverlayClass: 'fixed inset-0 z-[var(--z-modal-backdrop)] flex items-stretch justify-center bg-[rgba(15,23,42,0.82)] p-2 pt-[max(8px,env(safe-area-inset-top,0px))] md:items-center md:p-4',
            dialogShellClass: 'flex h-full max-h-full w-full flex-col overflow-hidden rounded-[20px] border border-slate-200 bg-white shadow-[0_18px_60px_rgba(15,23,42,0.35)] md:h-[calc(100dvh-32px)] md:max-h-[calc(100dvh-32px)] md:max-w-[min(1480px,calc(100vw-32px))] md:rounded-[24px] md:border md:border-slate-200 md:bg-white/98 md:shadow-[0_28px_120px_rgba(148,163,184,0.28)]',
            dialogHeaderClass: 'sticky top-0 z-10 flex shrink-0 flex-col gap-3 border-b border-slate-200 bg-white/96 px-4 pb-4 pt-4 backdrop-blur md:flex-row md:items-center md:justify-between md:px-5',
    ...
    return {
        ...
        dialogOverlayClass: 'fixed inset-0 z-[var(--z-modal-backdrop)] flex items-stretch justify-center bg-[#030617]/[0.92] p-2 pt-[max(8px,env(safe-area-inset-top,0px))] md:items-center md:p-4',
        dialogShellClass: 'flex h-full max-h-full w-full flex-col overflow-hidden rounded-[20px] border border-white/10 bg-slate-950 shadow-[0_18px_60px_rgba(2,6,23,0.6)] md:h-[calc(100dvh-32px)] md:max-h-[calc(100dvh-32px)] md:max-w-[min(1480px,calc(100vw-32px))] md:rounded-[24px] md:border md:border-white/10 md:bg-slate-950/96 md:shadow-[0_28px_120px_rgba(2,6,23,0.46)]',
        dialogHeaderClass: 'sticky top-0 z-10 flex shrink-0 flex-col gap-3 border-b border-white/10 bg-slate-950/92 px-4 pb-4 pt-4 backdrop-blur md:flex-row md:items-center md:justify-between md:px-5',
