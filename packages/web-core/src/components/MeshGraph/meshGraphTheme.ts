...
export function getMeshGraphTheme(theme: Theme): MeshGraphTheme {
    if (theme === 'light') {
        return {
            ...
            dialogOverlayClass: 'fixed inset-0 z-[1200] flex items-stretch justify-center bg-[rgba(148,163,184,0.22)] p-0 md:items-center md:p-4 backdrop-blur-md',
    ...
    return {
        ...
        dialogOverlayClass: 'fixed inset-0 z-[1200] flex items-stretch justify-center bg-[#030617]/[0.58] p-0 md:items-center md:p-4 backdrop-blur-md',
