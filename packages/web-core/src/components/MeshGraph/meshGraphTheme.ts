...
export function getMeshGraphTheme(theme: Theme): MeshGraphTheme {
    if (theme === 'light') {
        return {
            ...
            dialogOverlayClass: 'fixed inset-0 z-[1200] flex items-center justify-center bg-[rgba(148,163,184,0.22)] p-3 md:p-4 backdrop-blur-md',
            dialogShellClass: 'flex max-h-[92dvh] w-full max-w-4xl flex-col overflow-hidden rounded-[24px] border border-slate-200 bg-white/98 shadow-[0_28px_120px_rgba(148,163,184,0.28)] md:max-h-[82vh]',
            ...
            dialogBodyClass: 'min-h-0 flex-1 flex flex-col bg-[linear-gradient(180deg,rgba(248,250,252,0.98),rgba(241,245,249,0.96))] px-4 py-4 md:px-5 md:py-5',
    ...
    return {
        ...
        dialogOverlayClass: 'fixed inset-0 z-[1200] flex items-center justify-center bg-[#030617]/[0.58] p-3 md:p-4 backdrop-blur-md',
        dialogShellClass: 'flex max-h-[92dvh] w-full max-w-4xl flex-col overflow-hidden rounded-[24px] border border-white/10 bg-slate-950/96 shadow-[0_28px_120px_rgba(2,6,23,0.46)] md:max-h-[82vh]',
        ...
        dialogBodyClass: 'min-h-0 flex-1 flex flex-col bg-[linear-gradient(180deg,rgba(2,6,23,0.95),rgba(15,23,42,0.98))] px-4 py-4 md:px-5 md:py-5',
