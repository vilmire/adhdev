...
function graphNode(overrides: Partial<MeshGraphNode>): MeshGraphNode {
  return {
    ...
    daemonId: overrides.daemonId ?? 'daemon-1',
    machineId: overrides.machineId ?? 'mach_1',
    machineLabel: overrides.machineLabel ?? 'Mac Studio',
    locality: overrides.locality ?? 'remote',
    connectionTransport: overrides.connectionTransport ?? null,
    connectionState: overrides.connectionState ?? null,
    connectionReason: overrides.connectionReason ?? null,
    connectionReported: overrides.connectionReported ?? false,
    connectionRttMs: overrides.connectionRttMs ?? null,
