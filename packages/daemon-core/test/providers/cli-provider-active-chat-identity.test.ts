...
describe('CliProviderInstance active chat identity', () => {
    it('uses exact runtime/provider identity instead of provider+workspace for same-workspace CLI sessions', () => {
        const first = new CliProviderInstance(withMinimalSpec(provider as any) as any, '/workspaces/shared', [], 'runtime-session-1', undefined, {
            providerSessionId: 'provider-session-1',
        });
        const second = new CliProviderInstance(withMinimalSpec(provider as any) as any, '/workspaces/shared', [], 'runtime-session-2', undefined, {
    ...
    it('falls back to runtime instance id before workspace identity when provider session is not known yet', () => {
        const first = new CliProviderInstance(withMinimalSpec(provider as any) as any, '/workspaces/shared', [], 'runtime-session-1');
        const second = new CliProviderInstance(withMinimalSpec(provider as any) as any, '/workspaces/shared', [], 'runtime-session-2');
    ...
    it('does not use a generic adapter runtime id as the active chat identity', () => {
        const instance = new CliProviderInstance(withMinimalSpec(provider as any) as any, '/workspaces/shared', [], 'runtime-session-1');
